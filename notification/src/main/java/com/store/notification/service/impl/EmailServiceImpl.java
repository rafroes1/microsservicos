...
public class EmailServiceImpl extends GenericServiceImpl{
    ...
    public String constructOrderContent(String cart_id, String username){
        return MessageFormat.format("<html><body><h1>Olá {0}</h1><p>Seu carrinho de compra #{1} já está pago e confirmado e logo sairá para entrega!<p></body></html>", username, cart_id);
    }
